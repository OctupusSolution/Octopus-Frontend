...
const CATEGORIES: readonly MenuCategory[] = [
  { id: "cat-main", slug: "main", name: "الأطباق الرئيسية", imageUrl: `${IMG}/all.png` },
  { id: "cat-breakfast", slug: "breakfast", name: "الإفطار", imageUrl: `${IMG}/breakfast.webp` },
  { id: "cat-lunch", slug: "lunch", name: "الغداء", imageUrl: `${IMG}/meat.webp` },
  { id: "cat-desserts", slug: "desserts", name: "الحلويات", imageUrl: `${IMG}/cake.png` },
  { id: "cat-drinks", slug: "drinks", name: "المشروبات", imageUrl: `${IMG}/drinks.webp` },
];

// Reading order of the chip rail, from the start edge. Every chip has its own
// photograph except salads, which reuses the side-dishes plate of grilled
// vegetables until a salad shot arrives — the nearest honest stand-in.
const MENU_GROUPS: readonly MenuGroup[] = [
  { id: "all", imageUrl: `${IMG}/all.png` },
  { id: "chicken", imageUrl: `${IMG}/chicken.png` },
  { id: "meat", imageUrl: `${IMG}/meat.webp` },
  { id: "burger", imageUrl: `${IMG}/burger.webp` },
  { id: "pizza", imageUrl: `${IMG}/pizza.png` },
  { id: "sides", imageUrl: `${IMG}/side-dishes.png` },
  { id: "appetizers", imageUrl: `${IMG}/appetizers.png` },
  { id: "salads", imageUrl: `${IMG}/side-dishes.png` },
];
...
const ITEMS: readonly MenuItem[] = [
  {
    ...
    imageUrl: `${IMG}/burger.webp`,
    images: [`${IMG}/burger.webp`, `${IMG}/burger.webp`, `${IMG}/burger.webp`],
    available: true,
    inStock: true,
